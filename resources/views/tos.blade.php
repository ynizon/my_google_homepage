...
@section('content')
    <div class="faq">
        <h2>Conditions de service de https://google.gameandme.fr</h2>
        <p>
            <strong>Dernière modification: 04/10/2018</strong>
            <br/>
            <br/>
        ...
        <p>
            En visitant le site, ou en utilisant le service, vous indiquez que vous acceptez de respecter ces conditions.
        ...
        <p>
            Notre politique de confidentialité, située à l'adresse https://google.gameandme.fr/faq.php, est régie par les présentes règles.
            En acceptant ces conditions, vous acceptez d'être lié par les termes de la politique de confidentialité et acceptez
            que nous puissions utiliser les informations recueillies auprès de vous conformément à ses termes.
        </p>

        <h2>3. Avis concernant le règlement des litiges</h2>
        <p>
            Ces conditions contiennent des dispositions qui régissent la manière dont les réclamations que vous et nous pourrions avoir l'un contre l'autre sont résolues,
            y compris un accord et une obligation d'arbitrer les différends, ce qui, sous réserve d'exceptions limitées, vous obligera à soumettre vos réclamations à un arbitrage exécutoire,
            à moins que vous vous désengagez de l'arbitrage comme décrit ci-dessous. br/>
            Si vous ne vous retirez pas de l'arbitrage, vous serez uniquement autorisé à poursuivre des actions en justice et à demander réparation
            (y compris des mesures pécuniaires, injonctives et déclaratoires) à notre encontre, et non dans le cadre d'une action ou d'une procédure collective ou représentative.
        </p>

        <h2>4. Mises à jour de ces conditions</h2>
        <p>
            Nous pouvons modifier ces conditions de temps en temps. Nous vous informerons des changements importants conformément aux lois applicables.
            Si vous n'êtes pas d'accord avec les modifications proposées, vous devez cesser d'utiliser le service .
            Si vous continuez à utiliser le Service après l'entrée en vigueur des nouvelles conditions, vous serez lié par les conditions modifiées.
        </p>

        <h2>5. Représentations affirmatives</h2>
        <p>
            Lorsque vous utilisez le service, vous déclarez que:
        <ul>
            <li>votre utilisation du Service ne viole aucune loi ou réglementation applicable;</li>
            <li>vous avez 13 ans ou plus; et</li>
            <li>vous avez l'âge légal ou la capacité juridique pour entrer légalement dans les présentes.</li>
        </ul>
        </p>

        <h2>6. Conditions préalables et activation</h2>
        <p>
        ...
        <ul>
            <li>Identité</li>
            <li>Photos et fichiers média</li>
        </ul>
        </p>

        <h2>7. Précautions importantes</h2>
        <p>
            Ce site ne peut pas affecter votre ordinateur ni les fichiers qu'il contient.
        </p>

        <h2>8. Nos droits de propriété intellectuelle.</h2>
        <p>
        ...
        <p>
            ...
            <br/><br/>
            NOUS N'ASSUMONS AUCUNE RESPONSABILITÉ POUR :<br/>
            (A) DES ERREURS OU DES INEXACTITUDES DE CONTENU ET DE MATÉRIAUX, <br/>
            (B) DE BLESSURES OU DE DOMMAGES À LA PROPRIÉTÉ, DE TOUTE NATURE QUE CE SOIT, RÉSULTANT DE VOTRE ACCÈS ET DE L'UTILISATION DU SERVICE, <br/>
            (C) ACCÈS NON AUTORISÉ À OU UTILISATION DE NOS SERVEURS SÉCURISÉS ET / OU À TOUTES LES INFORMATIONS PERSONNELLES CONSERVÉES, <br/>
            (D) TOUTE INTERRUPTION OU CESSATION DE LA TRANSMISSION VERS LE SERVICE, <br/>
            (E) DE TOUTE BOGUE, VIRUS, CHEVAL DE TROJAN OU ALK. QUI PEUT ÊTRE TRANSMIS AU SERVICE PAR UN TIERS, OU PAR LE TIERS<br/>
            ...
            TRANSMIS OU DISPONIBLE AUTREMENT PAR LE SERVICE.<br/>
            <br/>
        ...
        <h2>12. Limite de responsabilité.</h2>
        <p>
            DANS LA MESURE AUTORISÉE PAR LA LOI APPLICABLE, EN AUCUN CAS, NOUS NE POURRONS ÊTRE TENUS RESPONSABLES DE TOUT TIERS,
            DE TELS DOMMAGES INDIRECTS, CONSÉCUTIFS, ACCESSOIRES, SPÉCIAUX OU PUNITIFS, Y COMPRIS LES DOMMAGES PROFITS RÉSULTANT DE VOTRE UTILISATION DU SERVICE,
            DE TOUT MATÉRIEL, TOUT AUTRE CONTENU. LE NON RESPECT DE CE CONTRAIRE CONTENU DANS LES PRÉSENTES CONDITIONS GÉNÉRALES DE SERVICE,
            DE NOTRE RESPONSABILITÉ À L'ÉGARD DE TOUTE PERTE OU DE DOMMAGE SUBI PAR VOUS ET ENCORE LIÉ À CES CONDITIONS GÉNÉRALES DE SERVICE.
        </p>
        ...
        <h2>14. Politique de copyright</h2>
        <p>
            Toute personne qui estime que tout contenu disponible sur ou via le Service enfreint ses droits d'auteur peut soumettre une notification en vertu de la loi DMCA
            (Digital Millennium Copyright Act) à l'adresse email indiqué dans contactez nous et inclure les informations suivantes:
        <ul>
            <li>Une signature physique ou électronique d'une personne autorisée à agir pour le compte du propriétaire ou du mandataire d'un droit exclusif prétendument violé;</li>
            <li>Identification du copyright prétendu avoir été violé;</li>
            <li>Identification du matériel dont il est allégué qu'il est en infraction et son emplacement dans l'application ou le service;</li>
            <li>Informations raisonnablement suffisantes pour nous permettre de vous contacter;</li>
            <li>Une déclaration selon laquelle vous croyez de bonne foi que l’utilisation du matériel de la manière reprochée n’est pas autorisée par le propriétaire des droits d’auteur,
                son mandataire ou la loi, et;</li>
            <li>Une déclaration, faite sous peine de parjure, que les informations ci-dessus sont exactes et que vous êtes le titulaire des droits d'auteur
                ou êtes autorisé à agir pour le compte de celui-ci.</li>
        </ul>
        <br/>
        Nous respectons les droits de propriété intellectuelle d'autrui et répondrons aux notifications claires d'infraction présumée.
        Vous reconnaissez que si vous ne respectez pas toutes les exigences de cette section, votre notification risque de ne pas être valide.
        </p>

        <h2>15. Notre gestion du service; Inconduite de l'utilisateur</h2>
        <p>
            (1) Notre droit de gérer le service
            <br/><br/>
            Nous nous réservons le droit, mais ne contractons pas l'obligation de: <br/>
            (a) surveiller ou examiner le Service pour détecter toute violation de ces conditions et pour se conformer à nos politiques; <br/>
            (b) signaler aux autorités chargées de l'application de la loi et / ou intenter une action en justice contre toute personne qui enfreint le présent Statut; <br/>
            (c) gérer le Service de manière à protéger nos droits et nos biens et ceux de tiers, ou à faciliter le bon fonctionnement du Service; <br/>
            (d) de mettre fin à vos activités ou de vous bloquer, ainsi que d'autres utilisateurs, pour violation de ces conditions.<br/>
            <br/><br/>
        ...
        <p>
            Ces conditions seront à tous égards régis, interprétés et appliqués conformément aux lois françaises (sans donner effet à aucun choix ou conflit de lois).
            La Convention des Nations Unies sur les contrats de vente internationale de marchandises ne s'appliquera pas à cet accord.
        </p>

        <h2>19. Convention d'arbitrage</h2>
        <p>
        ...
        <h2>20. Lieu exclusif pour les litiges</h2>
        <p>
            Dans la mesure où les dispositions d'arbitrage énoncées ci-dessus ne s'appliquent pas, les parties conviennent que tout litige entre elles sera
            soumis exclusivement aux tribunaux étatiques ou fédéraux situés en France à Nantes (à l'exception des actions en justice
            pour petites litiges susceptibles d'être intentées). dans le comté où vous résidez). Les parties consentent expressément à la compétence
            exclusive à Nantes pour tout litige autre que les actions en justice concernant les petites créances.
        </p>

        <h2>21. Intégralité de l'accord</h2>
        <p>
            Le présent mandat constitue l’intégralité de l’accord entre vous et la Société en ce qui concerne l’objet des présentes
            et remplace toutes les déclarations, propositions, négociations et communications antérieures et contemporaines, écrites et orales.
        </p>

        <h2>22. Cession</h2>
        <p>
            La Société peut céder les présentes Conditions d'utilisation ou l'un quelconque des droits ou obligations énoncés dans les présentes
            et toute cause d'action découlant des présentes aux tiers, sans nécessité ni obligation de préavis aux utilisateurs.
        </p>

        <h2>23. Dérogations</h2>
        <p>
            La renonciation ou le défaut de l'une des parties d'exercer à quelque égard que ce soit un droit ou une disposition de ces conditions
            ne sera pas considérée comme une renonciation au droit ou à la disposition applicable.
        </p>

        <h2>24. Divisibilité.</h2>
        <p>
            Ces conditions fonctionneront dans toute la mesure permise par la loi. Si une disposition ou une partie d'une disposition de ces conditions est illégale,
            nulle ou inapplicable, cette disposition ou une partie de la disposition est réputée séparable de ces conditions et n'affectera pas la
            validité et le caractère exécutoire des autres dispositions.
        </p>

        <h2>25. Avis aux utilisateurs</h2>
        <p>
        ...
        <p>
            La Société ne sera pas responsable de tout manquement à ses obligations en vertu de la présente conditions en raison de circonstances indépendantes
            de sa volonté, y compris, sans limitation, actes de Dieu, guerre, émeute, terrorisme, embargos, actes des autorités civiles ou militaires, incendie, inondation , ou des accidents.
        </p>

        <h2>27. Entrepreneurs indépendants.</h2>
        <p>
            Aucune disposition de ces conditions ne sera considérée comme créant une relation d'agence, de partenariat, de coentreprise, d'employeur-employé ou de
            franchiseur-franchisé de quelque nature que ce soit entre nous et tout utilisateur.
        </p>

        <h2>28. Comment nous contacter</h2>
        <p>
            Si vous avez des questions sur ces conditions, veuillez nous contacter par email <a href='mailto:ynizon@gmail.com'>ynizon@gmail.com</a>.
        </p>
    </div>
@endsection
