...
Route::get('/player', 'ClockController@player');
Route::get('/clock', 'ClockController@clock');
Route::get('/clock/alarms', 'ClockController@alarms');
Route::get('/clock/events', 'ClockController@events');
Route::get('/clock/load/{id}', 'ClockController@loadAlarm');
Route::post('/clock/save', 'ClockController@saveAlarm');
Route::post('/clock/delete', 'ClockController@deleteAlarm');
